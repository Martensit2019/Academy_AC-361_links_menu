<template>
  <div id="navbar" class="navbar">
    ...
    lengthParams - {{ Object.keys($route.params).length }}<br />
    <!-- h - {{ Object.entries($route.params)[0][0] }}
    lengthParams - -->
    {{ Object.entries($route.params) }}<br />
    <!-- navItems - {{ navItems }} -->
    <div class="navbar__left_section">
      ...
      <div class="navbar__center_half ml_2">
        ...
        > -->
          ...
          :key="key"
          :to="{ 
            name: 'questions-programs-program_id',
            params: { 
...
export default {
  ...
  methods: {
    ...
    toLinkQuestions(path) {
      ...
      const arrayParams = Object.entries(this.$route.params);
      let name;
      let params = {};
      if (path !== "questions") {
        name = path;
        ...
        if (lengthParams === 1) {
          if (arrayParams[0][0] === "category_id") {
            name = path;
          } else {
            name =
              arrayParams[0][0] === "course"
        ...
        if (lengthParams === 2) {
          if (
            arrayParams[0][0] === "program_id" &&
            arrayParams[1][0] === "course_id"
          ) {
          ...
          // if (
          //   arrayParams[0][0] === "course" &&
          //   arrayParams[1][0] === "lecture"
          // ) {
          //   name = "questions-courses-course-lecture";
          // }
          // if (arrayParams[0][0] === "course" && arrayParams[1][0] === "kim") {
          //   name = "questions-courses-course-kim";
          // }
          if (arrayParams[0][0] === "course") {
            name =
              arrayParams[1][0] === "lecture"
        ...
        if (lengthParams === 3) {
          ...
          //   arrayParams[2][0] === "lecture_id"
          // ) {
          //   name = "questions-programs-program_slug-course_slug-lecture_slug";
          //   params = {
          //     program_slug: this.$route.params.program_id,
          //     course_slug: this.$route.params.course_id,
          //     lecture_slug: this.$route.params.lecture_id
          ...
          //   arrayParams[0][0] === "program_id" &&
          //   arrayParams[1][0] === "course_id" &&
          //   arrayParams[2][0] === "kim_id"
          // ) {
          //   name = "questions-programs-program_slug-course_slug-test-kim_id";
          //   params = {
          //     program_slug: this.$route.params.program_id,
          //     course_slug: this.$route.params.course_id,
          //     kim_id: this.$route.params.kim_id
